	    ...
	    public SecurityFilterChain filterChain(HttpSecurity http, JwtUtil jwtUtil, UserDetailsService userDetailsService) throws Exception {
	        ...
	        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
	            ...
	            .authorizeHttpRequests(authz -> authz
	                .requestMatchers("/", "/index.html", "/login.html", "/register.html", "/assets/**", "/users/register", "/users/login", "/uploads/**", "/users/auth/{id}", "/users/auth/update-image/{userId}", "/uploads/**", "/users/table/list", "/table.html", "/profile.html", "/FaQ.html", "/publicappchat", "/Chat.html")
	                .permitAll()
